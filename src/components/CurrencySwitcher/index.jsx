                ...
                <div className="user-dropdown-wrapper">
                  ...
                  {showDropdown && (
                    <div className="user-dropdown">
                      ...
                      <button className="header-btn admin-panel-btn" onClick={() => navigate('/ComingSoon')}>
                        {t('myShop') || 'My Shop'}
                      </button>
                      ...
                      <button className="header-btn admin-panel-btn" onClick={() => navigate('/ComingSoon')}>
                       ...
                       <div className="currency-switcher">
                        <label htmlFor="currency-select" className="currency-label">{t('currency') || 'Currency'}:</label>
                        <select
                          id="currency-select"
